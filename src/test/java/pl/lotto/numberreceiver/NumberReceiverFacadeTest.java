...
public class NumberReceiverFacadeTest {
    ...
    public void should_return_valid_ticket_when_user_gave_six_correct_numbers() {
        // given
        NumberReceiverFacade numberReceiver = new NumberReceiverFacade(date, numberReceiverRepository);
        // when
    ...
    public void should_return_correct_draw_date_for_valid_ticket() {
        ...
        NumberReceiverFacade numberReceiver = new NumberReceiverFacade(ticketClock, numberReceiverRepository);
    ...
    public void should_return_correct_draw_date_for_ticket_from_2023_1_21_after_12_00() {
        ...
        NumberReceiverFacade numberReceiver = new NumberReceiverFacade(ticketDate, numberReceiverRepository);
        // when
        DrawDateDto result = numberReceiver.retrieveDrawDate();
        // then
        assertThat(result.drawDate()).isEqualTo(drawDate);
    ...
    public void should_return_all_tickets() {
        ...
        NumberReceiverFacade numberReceiverFacade = new NumberReceiverFacade(date, numberReceiverRepository);
    ...
    public void should_return_tickets_for_given_date() {
        ...
        NumberReceiverRepository numberReceiverRepository = new InMemoryNumberReceiverRepositoryTestImpl();
        NumberReceiverFacade numberReceiverFacade = new NumberReceiverFacade(clock, numberReceiverRepository);
